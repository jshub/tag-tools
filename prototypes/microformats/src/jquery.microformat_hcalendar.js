...
(function(){
  var Plugin = {
    ...
    hcalendar : function(id) {
			var vendor = {
				...
				event_type : "event" // TODO ETL event type - should be a css_class instance?
			}
		  
		  // use existing plugin functions to parse and return data
			$.microformats.parseLocal({microformats: 'hEvent'});

			var hcalendars = $.microformats.hEvents;			
			return hcalendars;
		}
  };
  ...
  ETL.Plugin.hcalendar = Plugin.hcalendar;
})();
