(function(args) {
  ...
  var console = new function() {
    this.debug = function(msg) {
      print("tests.debug: " + msg);
    };
    this.log = function(msg) {
      print("tests.log: " + msg);
    };
    this.warn = function(msg) {
      print("tests.warn: " + msg);
    };
    this.error = function(msg) {
      print("tests.error: " + msg);
    };
  };
  ...
  var utils = {
    ...
    printReport: function(data) {
      console.log('Test Report: ' + data.results.passed + " Passed, " + data.results.failed + " Failed, " + data.results.ignored + " Ignored, " + data.results.total + " Total");
    },
...
//				testcase.failure = object.error.rhinoException.getScriptStackTrace();
	  ...
	  var path = 'test/reports/TEST-' + name.replace('/', '_') + '.xml';
      // save as file
      var out = new java.io.FileWriter(new java.io.File(path));
  ...
  window.onload = function() {
    ...
    window.console = new function() {
      ...
      this.debug = function() {
        print("console.debug: " + format.apply(this, arguments));
      };
      this.log = function() {
        print("console.log  : " + format.apply(this, arguments));
      };
      this.warn = function() {
        print("console.warn : " + format.apply(this, arguments));
      };
      this.error = function() {
        print("console.error: " + format.apply(this, arguments));
      };
      this.group = function() {
	  	print("console.group: " + indent + "+- " + format.apply(this, arguments));
	  	indent += "+ ";
      };
    ...
    TestRunner.subscribe(TestRunner.COMPLETE_EVENT, function(evt) {
      try {
        ...
        console.log("Tests complete in " + timeTaken + "ms");
