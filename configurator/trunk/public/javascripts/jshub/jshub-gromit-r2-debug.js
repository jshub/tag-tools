...
(function () {
  ...
  var parse = function parse(event) {
    ...
    sources.each(function (idx, elm) {
      ...
      hpage['page-title'] = hpage['page-title'] || ETL.safe('document').title;
      hpage['page-title-visibility'] = hpage['page-title-visibility'] || rootVisibility;
      hpage['page-referrer'] = hpage['page-referrer'] || ETL.safe('document').referrer;
   ...
   * to page view events
   */
  ETL.bind("page-view", "hPage-plugin", parse);
   ...
   */
  ETL.bind("content-updated", "hPage-plugin", parse);
